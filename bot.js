...
client7.login(process.env.BOT_TOKEN6);
client8.login(process.env.BOT_TOKEN7);
client9.login(process.env.BOT_TOKEN8);
client10.login(process.env.BOT_TOKEN9);
client11.login(process.env.BOT_TOKEN10);
client12.login(process.env.BOT_TOKEN11);
client13.login(process.env.BOT_TOKEN12);
client14.login(process.env.BOT_TOKEN13);
client15.login(process.env.BOT_TOKEN14);
client16.login(process.env.BOT_TOKEN15);
client17.login(process.env.BOT_TOKEN16);
client18.login(process.env.BOT_TOKEN17);
client19.login(process.env.BOT_TOKEN18);
client20.login(process.env.BOT_TOKEN19);
client21.login(process.env.BOT_TOKEN20);
client22.login(process.env.BOT_TOKEN21);
client23.login(process.env.BOT_TOKEN22);
client24.login(process.env.BOT_TOKEN23);
client25.login(process.env.BOT_TOKEN24);
client26.login(process.env.BOT_TOKEN25);
client27.login(process.env.BOT_TOKEN26);
client28.login(process.env.BOT_TOKEN27);
client29.login(process.env.BOT_TOKEN28);
client30.login(process.env.BOT_TOKEN29);
client31.login(process.env.BOT_TOKEN30);
client32.login(process.env.BOT_TOKEN31);
client33.login(process.env.BOT_TOKEN32);
client34.login(process.env.BOT_TOKEN33);
client35.login(process.env.BOT_TOKEN34);
client36.login(process.env.BOT_TOKEN35);
client37.login(process.env.BOT_TOKEN36);
client38.login(process.env.BOT_TOKEN37);
client39.login(process.env.BOT_TOKEN38);
client40.login(process.env.BOT_TOKEN39);
client41.login(process.env.BOT_TOKEN40);
client42.login(process.env.BOT_TOKEN41);
client43.login(process.env.BOT_TOKEN42);
client44.login(process.env.BOT_TOKEN43);
client45.login(process.env.BOT_TOKEN44);
client46.login(process.env.BOT_TOKEN45);
